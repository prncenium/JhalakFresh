...
// CHANGED: Renamed function from NewPage to RealAdultPlans
export default function RealKidsPlans() {
  return (
    <div className="w-full min-h-screen flex flex-col items-center bg-[#fff]">
      ...
      <div className="w-full max-w-[1700px] px-[20px] md:px-[40px] mt-[80px] mb-[40px] flex items-center justify-start gap-[16px]">
        ...
        <svg width="52" height="53" viewBox="0 0 24 24" fill="none" stroke="#2a2a2a" strokeWidth="2.7" strokeLinecap="round" strokeLinejoin="round">
          <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
        </svg>
        {/* Heading Text */}
        <h2 className="font-juicy text-[50px] md:text-[78px] text-[#2a2a2a] leading-[0.77] pt-[10px]">
          Wellness Programs
        </h2>
      </div>
...
>
  ...
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
      ...
      <div className="w-full max-w-[1700px] px-[20px] md:px-[40px] mb-[40px] flex items-center justify-start gap-[16px]">
        {/* Users/Group Icon */}
        <svg width="62" height="60" viewBox="0 0 24 24" fill="none" stroke="#2a2a2a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
