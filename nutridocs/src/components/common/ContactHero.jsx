...
// CHANGED: Added 'type' prop (defaults to 'contact') to switch between layouts
export default function ContactHero({ type = "contact" }) {
  const isBook = type === "books";

  return (
    <section className="relative w-full max-w-[1928px] flex flex-col items-center justify-center overflow-hidden bg-[#fafcfc] pt-[140px] pb-[80px]">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        {/* Dynamic Badge */}
        <div className="bg-white/80 backdrop-blur-sm px-[92px] py-[22px] rounded-full shadow-[0_4px_15px_rgba(0,0,0,0.06)] flex items-center justify-center gap-[12px] mb-[120px] mt-[10px]">
          {isBook ? (
            /* Book Route Badge */
            <>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#67bcc1" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex flex-col items-center mb-[80px]">
          {isBook ? (
            <>
              <p className="font-inter text-[32px] text-[#6b6b6b] leading-[1.32] mb-[18px]">
                Transform your life with expert guidance
              </p>
              <p className="font-inter font-bold text-[32px] text-[#009da6] leading-[1.32]">
        ...
        {/* --- Quick Info Cards (Only renders on Contact page) --- */}
        {!isBook && (
